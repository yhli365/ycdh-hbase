...
import com.hadoopbook.common.NcdcRecordParser;

/**
 * Uses {@link HTable} to load temperature data into a HBase table directly.
 * Less efficient than {@link HBaseTemperatureImporter} (since auto-flush is
 * enabled) and {@link HBaseTemperatureBulkImporter} in particular.
 */
public class HBaseTemperatureDirectImporter extends Configured implements Tool {

	static class HBaseTemperatureMapper<K, V> extends
		...
		protected void setup(Context context) throws IOException {
			...
			this.table = new HTable(HBaseConfiguration.create(context
					.getConfiguration()), "observations");
		}
